...
start = time.time()
import sys
sys.path.append('/home/ysw/catkin_ws/src/visualizer/src/posenet_pytorch')
...
def main(config):
    ...
    print("Time spent on list(self.data_loader)...: ", time.time() - start)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='/home/ysw/catkin_ws/src/visualizer/src/posenet_pytorch/data')
    ...
    parser.add_argument('--metadata_path', type=str, default='/home/ysw/catkin_ws/src/visualizer/src/posenet_pytorch/data/dataset_test.txt')
    ...
    config = parser.parse_args(sys.argv[10:])
    main(config)
